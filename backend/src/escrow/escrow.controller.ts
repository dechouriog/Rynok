...
export class EscrowController {
  ...
  @ApiOperation({ summary: 'Registrar un depósito ya confirmado on-chain' })
  ...
  @Get(':propertyId')
  @ApiOperation({ summary: 'Ver el estado de escrow de una propiedad' })
  ...
  @ApiBearerAuth('access-token')
  @ApiOperation({ summary: 'Confirmar que los fondos se liberaron (solo el comprador)' })
  @UseGuards(WalletAuthGuard)
  confirm(
    ...
    return this.service.confirmRelease(propertyId, user.wallet, releaseTxHash);
  }
}